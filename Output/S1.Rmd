...
In method (B) we expanded model 2 to allow the force of infection ($foi$) between two neighborhoods to vary depending
...
border. The resulting $foi_{i,j}$ can be described as
