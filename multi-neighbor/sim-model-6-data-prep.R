...
z <- combine.MCMC(jags_m6_ls) # Combine different reps into one
rm(jags_m6_ls)
gc() # garbage collection after remove large object
...
rm(int_hpd)
save(list = ls(), file = 'data/Rdata/sim-model-6-data.Rdata' )
