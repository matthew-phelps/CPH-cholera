...
system.time(
  ggsave(model_1_full_sim_plot,
         file = 'C:\\Users\\wrz741\\Google Drive\\Copenhagen\\DK Cholera\\CPH\\Output\\Simulations\\CHRIST-short-Fig-1-model-1-full-sim.jpg',
         width=15, height=9,
         units = 'in')
)
 # Mac save:
...
model_1_tplus1_melt <- tidyr::gather(model_1_tplus1, day_index, value = value)
...
ggsave(model_1_tplus1_plot, 
       file = '/Users/Matthew/Google Drive/Copenhagen/DK Cholera/CPH/Output/Simulations/CHRIST-Fig-2-model-1-tplus1-sim.jpg',
       width=9, height=9,
       units = 'in')
