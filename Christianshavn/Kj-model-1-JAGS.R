...
# SAVE --------------------------------------------------------------------
save(model_1_jags_list, file = "Data\\Rdata\\Kj-model-1-jags-list.Rdata")
save(dataList, file = "Data\\Rdata\\Kj-model-1-dataList.Rdata")
# # JAGS DIAGNOSTICS -
...
save(mcmc_total, file = "Data\\Rdata\\Kj-mcmc_total.Rdata")
ggsave(beta_posterior, file = "Output\\MCMC\\Kj-beta_posteriors.png")
ggsave(phi_posteriors, file = "Output\\MCMC\\Kj-phi_posteriors.png")
