...
load(file = 'Data/Rdata/beta-summary-1-CHRIST.Rdata')
load(file = 'Data/Rdata/phi-summary-1-CHRIST.Rdata')
load(file = 'Data/Rdata/model-1-jags-CHRIST.Rdata')
load("Data/Rdata/model-1-dataList-CHRIST.Rdata")
...
save(list = ls(), file = 'data/Rdata/model-1-sim_data-CHRIST.Rdata' )
